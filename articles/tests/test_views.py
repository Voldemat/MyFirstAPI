...
class ArticleViewSetTestCase(ViewSetTestCaseMethodGet, TestCase):
	class Meta:
		model = Article
		datalist = [
...
class ArticleGalleryViewSetTestCase(ViewSetTestCaseMethodGet, TestCase):
	class Meta:
		model = Article
		datalist = [
			Data.article_test_data,
		...
		reference_objects_name = 'gallery'
		list_reverse_name = 'galleries-list'
		detail_reverse_name = 'galleries-detail'
