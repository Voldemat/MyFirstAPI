...
from modules.tests import BaseModelViewTestCase, Request, RequestReverse
...
# class ArticleViewSetTestCase(BaseModelViewTestCase, TestCase):
# 	class Meta:
# 		model = Article
# 		datalist = [
# 			Data.article_test_data,
# 		]
# 		requests_list = [
# 			RequestReverse(reverse_name = 'articles-detail', reverse_args = [Data.article_test_data['id']], method = 'GET'),
# 			RequestReverse(reverse_name = 'articles-list')
# 		]


# class ArticleGalleryViewSetTestCase(BaseModelViewTestCase, TestCase):
# 	class Meta:
# 		model = ArticleGallery
# 		ref_model = Article
# 		ref_field = 'article'
# 		datalist = [
# 			Data.articlegallery_test_data,
# 			# Data.articlegallery_test_data_2,
# 		]
# 		ref_datalist = [
# 			Data.article_test_data_2,
# 			# Data.article_test_data_2,
# 		]
# 		requests_list = [
# 			RequestReverse(reverse_name = 'galleries-list'),
# 			RequestReverse(reverse_name = 'galleries-detail', reverse_args = [Data.articlegallery_test_data['id']])
# 		]



# 	def test_url(self):
# 		print(self.list_response.request['PATH_INFO'])
